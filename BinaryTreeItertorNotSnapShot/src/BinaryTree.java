...
public class BinaryTree<T> implements Iterable<T> {
	...
	// this is a pre-Order Traversal method
	private class BinaryTreeIterator implements Iterator<T> {
		...
		public T next() {
			...
			// case 2: current has a right child
			else if (current.right != null) {
				current = current.right;
			}

			// Case 3: current is a lead -> Search for the first ancestor that has a right
			// child that has not been processed
			else {
